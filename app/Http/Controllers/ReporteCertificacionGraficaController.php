...
class ReporteCertificacionGraficaController extends Controller
{
    ...
    public function index()
    {
        ...
        $etiquetasEstados = 0;
        $valoresEstados = 0;
        return view('reporteCertificacionGrafica.index',compact('EmpresasP','periodos','datosUsuarios','etiquetasEstados','valoresEstados','certificacion','periodosT','principalesTexto','usuarioAqua','usuarioABBChile','usuarioNOKactivo','usuarioClaroChile'));
    }
