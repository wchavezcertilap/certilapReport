    ...
    <div class="col-md-12">     
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Descarga Masiva de Certificados</h3>
        </div>
      </div>
    </div>
  </div>      
  @include('messages')
  <form method="POST" action="{{ route('certificadoMasivo.store') }}" role="form" class="form-horizontal" id="formDocumentos">
