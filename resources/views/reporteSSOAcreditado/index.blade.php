...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">SSO Acreditación</li>
  </ol>
</section>
</br>
    ...
    <div class="col-md-12">     
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Reporte SSO Acreditación.</h3>
        </div>
      </div>
    </div>
  </div>      
  @include('messages')
  <form method="POST" action="{{ route('reporteSSOClaro.store') }}" role="form" class="form-horizontal" id="formDocumentos">
