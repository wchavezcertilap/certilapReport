    ...
    <div class="col-md-12">     
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Reportes Completo Certificación Laboral</h3>
        </div>
      </div>
    </div>
  </div>      
  @include('messages')
  <form method="POST" action="{{ route('reporteCompleto.store') }}" role="form" class="form-horizontal" id="formReporteCompleto">
              ...
              <div class="box-body">
                ...
                <div class="box-body">
                  <div class="form-group">
                      ...
                      <label for="estadoCertificado" class="col-sm-2 control-label">Estado de Certifición</label>
                        <div class="col-sm-4">
                     
                          <select class="form-control" name="estadoCertificado" id="estadoCertificado">
...
@isset($cuentaTrabajador)
@if (count($cuentaTrabajador))
<div class="row">
    <div class="col-md-12">     
