...
<section class="content-header">
  <h1>
    Reportes Certificacion / Facturación 
  </h1>
  <ol class="breadcrumb">
    ...
    <li class="active">Reporte Certificación / Facturación </li>
  </ol>
</section>
</br>
    ...
    <div class="col-md-12">     
      <div class="box box-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Reportes Certificación / Facturación</h3>
        </div>
      </div>
    </div>
  </div>      
  @include('messages')
  <form method="POST" action="{{ route('reporteFactCert.store') }}" role="form" class="form-horizontal" id="formReporte">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                  <div class="form-group">
                      ...
                      <label for="estadoCertificacion" class="col-sm-2 control-label">Estados de Certificación</label>
                        <div class="col-sm-4">
                          <select class="form-control js-example-basic-multiple" name="estadoCertificacion[]" id="estadoCertificacion" multiple="multiple">
                            <option value="0" selected="selected">Seleccione Estados</option>
              ...
              <div class="box-body">
                  <div class="form-group">
                    <label for="tipoPago" class="col-sm-2 control-label">Tipo de Pago</label>
                        <div class="col-sm-4">
                          <select class="form-control js-example-basic-multiple" name="tipoPago[]" id="tipoPago" multiple="multiple">
                            <option value="0" selected="selected">Seleccione Tipo Pago</option>
                            <option value="100">Todos</option>
                            <option value="1">WebPay, Transferencia, Deposito</option>
                            <option value="0">Pago Directo</option>
                          </select> 
                        </div>

                       <!--  <label for="fechas" class="col-sm-2 control-label">Fecha de Pago</label>
                        <div class="col-sm-3 input-group">
                           <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control" id="fechaPago" name="fechaPago" value="" autocomplete="off">
                       </div> -->
                  </div> 
...
$(function () {
  ...
  $('#fechaPago').on('apply.daterangepicker', function(ev, picker) {
      $(this).val(picker.startDate.format('DD-MM-YYYY')+'_'+picker.endDate.format('DD-MM-YYYY'));
  });

  $('#fechaPago').on('cancel.daterangepicker', function(ev, picker) {
      $(this).val('');
  });*/
    ...
    if(tipoBsuqueda == 1){
      ...
      if(fechaSeleccion == "" || fechaSeleccion == null ){
        ...
        toastr.error("","<br>Debe seleccionar Empresa Principal<br><br>").css({"width"  : "30%" , "text-align" : "center"});
         valida = 1;
    }if(estadoCertificacion == 0){
        $("#estadoCertificacion").css({"border":"1px solid red  !important"});
        toastr.error("","<br>Debe seleccionar un tipo de estado de certificacion<br><br>").css({"width"  : "30%" , "text-align" : "center"});
         valida = 1;
    }if(tipoPago == "" || tipoPago == 0){
        $("#tipoPago").css({"border":"1px solid red  !important"});
        toastr.error("","<br>Debe seleccionar un tipo de Pago<br><br>").css({"width"  : "30%" , "text-align" : "center"});
         valida = 1;
    }
   /* if(fechaPago == "" || fechaPago == null ){
        $("#fechaPago").css({"border":"1px solid red  !important"});
        toastr.error("","<br>Debe seleccionar Fecha de pago<br><br>").css({"width"  : "30%" , "text-align" : "center"});
         valida = 1;
      }*/
    if(valida == 0){
